...
{
    public class MasterHomePageManagementController : CustomController
    {
        #region Tree
        ...
        //    var userid = 0;
        //    var data = new HomePage().GetPage(request, whereCondition, isactive, userid);
        //    return Json(data);
        //}
        ...
        public ActionResult FormPopup(string entryid, string entrykey, string redirectbyajax)
        {
            ...
            return View("HomePageManagementForm", dict);
        ...
        public ActionResult UpdateActiveStatus(int entryid, bool isactive)
        {
            ...
            try
            {
                var isExist =HomePage.GetById(entryid, null, false);
        ...
        public ActionResult GetByID(int entryid)
        {
            ...
            try
            {
                var data =HomePage.GetById(entryid, null, false);
