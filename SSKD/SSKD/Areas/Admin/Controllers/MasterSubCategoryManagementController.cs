...
{
    public class MasterSubCategoryManagementController : CustomController
    {
        #region Tree
        public ActionResult Index(string redirectbyajax, string entryid, string actiontype, string fa)
        {
            ...
            return View("SubCategoryManagementTree", dict);
        ...
        public ActionResult Read([DataSourceRequest]DataSourceRequest request, string isactive)
        {
            ...
            var userid = 0;
            var data = new SubCategory().GetPage(request, whereCondition, isactive, userid);
            return Json(data);
        }
        ...
        public ActionResult FormPopup(string entryid, string entrykey, string redirectbyajax)
        {
            ...
            return View("SubCategoryManagementForm", dict);


        }

        [HttpPost]
        public ActionResult Create(SubCategory item)
        {
            ...
            try
            {
                ...
                var isExist = SubCategory.GetById(item.entryid, null, false) ;
        ...
        public ActionResult UpdateActiveStatus(int entryid, bool isactive)
        {
            ...
            try
            {
                var isExist =SubCategory.GetById(entryid, null, false);
        ...
        public ActionResult GetByID(int entryid)
        {
            ...
            try
            {
                var data =SubCategory.GetById(entryid, null, false);
