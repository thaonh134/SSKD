    ...
    public class MasterCategoryManagementController : CustomController
    {
        ...
        public ActionResult Create(Category item)
        {
            ...
            try
            {
                ...
                var isExist = Category.GetById(item.entryid, null, false) ;
        ...
        public ActionResult UpdateActiveStatus(int entryid, bool isactive)
        {
            ...
            try
            {
                var isExist =Category.GetById(entryid, null, false);
        ...
        public ActionResult GetByID(int entryid)
        {
            ...
            try
            {
                var data =Category.GetById(entryid, null, false);
        ...
        [HttpPost]
        public ActionResult GetCategoryForDDL()
        {
            try
            {
                var data = CustomModel.GetCategoryForDDL();
